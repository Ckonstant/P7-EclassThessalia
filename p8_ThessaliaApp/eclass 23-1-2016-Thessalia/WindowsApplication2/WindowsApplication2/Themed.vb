...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .DrawString(Text, _Font, New SolidBrush(Color.FromArgb(45, 45, 48)), New Point(5, 5))
        End With
        MyBase.OnPaint(e)
        G.Dispose()
...
Public Class ElegantThemeComboBox
    Inherits ComboBox
...
#Region "Variables"
    ...
    Private _SeperatorColour As Color = Color.FromArgb(23, 119, 151)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        With G
            ...
            For i As Integer = 0 To TabCount - 1
                Dim tabRect1 As New Rectangle(GetTabRect(i).Location.X - 4, GetTabRect(i).Location.Y + 2, GetTabRect(i).Size.Width - 0, GetTabRect(i).Size.Height - 11)
                If i = SelectedIndex Then
                    Dim tabRect As New Rectangle(GetTabRect(i).Location.X + 5, GetTabRect(i).Location.Y + 2, GetTabRect(i).Size.Width + 5, GetTabRect(i).Size.Height - 11)
                    ...
                    .DrawString(TabPages(i).Text, New Font("Segoe UI", 9, FontStyle.Bold), New SolidBrush(Color.White), tabRect1, New StringFormat With {.LineAlignment = StringAlignment.Center, .Alignment = StringAlignment.Center})
...
Public Class ElegantThemeOnOffSwitch
    Inherits Control
...
#Region "Properties & Events"
    ...
    Protected Overrides Sub OnMouseMove(e As MouseEventArgs)
        ...
        MouseXLoc = e.Location.X
        Invalidate()
        If e.X < Width - 40 AndAlso e.X > 40 Then Cursor = Cursors.IBeam Else Cursor = Cursors.Hand
    End Sub

    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        MyBase.OnMouseDown(e)
        If MouseXLoc >= Width / 2 Then
            _Toggled = Toggles.Toggled
            ToggledValue()

        ElseIf MouseXLoc < Width / 2 Then
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        With G
            ...
            If _Toggled = Toggles.Toggled Then
                .FillRectangle(New SolidBrush(_BaseColour), New Rectangle(CInt(Width / 3), 10, CInt(Width / 2 - 39), 3))
                .FillRectangle(New SolidBrush(_BaseColour), New Rectangle(Width - 117, 2, 36, Height - 5))
                ...
                .DrawString("ΕΑΡ", New Font("Microsoft Sans Serif", 7, FontStyle.Bold), New SolidBrush(_TextColour), New Rectangle(2, -1, CInt(Width - 20 + 20 / 3), Height), New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Center})
                .DrawString("ΧΕΙ", New Font("Microsoft Sans Serif", 7, FontStyle.Bold), New SolidBrush(_NonToggledTextColour), New Rectangle(CInt(20 - 20 / 3 - 6), -1, CInt(Width - 20 + 20 / 3), Height), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
            ElseIf _Toggled = Toggles.NotToggled Then
                
                .FillRectangle(New SolidBrush(_ToggledColour), New Rectangle(CInt(Width / 3), 10, CInt(Width / 2 - 39), 3))
                .FillRectangle(New SolidBrush(_ToggledColour), New Rectangle(Width - 117, 2, 36, Height - 5))
                .DrawString("ΧΕΙ", New Font("Microsoft Sans Serif", 7, FontStyle.Bold), New SolidBrush(_TextColour), New Rectangle(CInt(20 - 20 / 3 - 6), -1, CInt(Width - 20 + 20 / 3), Height), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
                .DrawString("ΕΑΡ", New Font("Microsoft Sans Serif", 7, FontStyle.Bold), New SolidBrush(_NonToggledTextColour), New Rectangle(2, -1, CInt(Width - 20 + 20 / 3), Height), New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Center})
            End If
