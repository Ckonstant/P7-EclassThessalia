Public Class Main
    ...
    Private Sub ElegantThemeLabel1_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ElegantThemeLabel2_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Form8_Load(sender As Object, e As EventArgs) Handles Me.Load
        Timer1.Start()
        Label14.Text = "Συνδεδεμένος ως:" + Login.ElegantThemeTextBox1.Text
    End Sub
    ...
    Private Sub ElegantThemeLabel4_Click(sender As Object, e As EventArgs) Handles ElegantThemeLabel4.Click
        Me.Close()
        Form1.Show()
    End Sub
